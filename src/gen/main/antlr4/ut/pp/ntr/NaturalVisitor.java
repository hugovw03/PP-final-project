...
public interface NaturalVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code declGlobal}
	 * labeled alternative in {@link NaturalParser#stat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDeclGlobal(NaturalParser.DeclGlobalContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link NaturalParser#lockStatus}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLockStatus(NaturalParser.LockStatusContext ctx);
	/**
