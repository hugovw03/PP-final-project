...
public class NaturalLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"INT", "BOOL", "IF", "ELSE", "WHILE", "PRINT", "LOCAL", "GLOBAL", "LOCK", 
			"TRUE", "FALSE", "DOT", "ASSIGN", "LT", "GT", "EQ", "NE", "LET", "SET", 
			"NOT", "SEMICOLON", "LBRAC", "RBRAC", "LPAR", "RPAR", "TIMES", "PLUS", 
			"MINUS", "RUNPAR", "LETTER", "DIGIT", "ID", "NUM", "STRING", "COMMENT", 
			"WS"
		};
	}
